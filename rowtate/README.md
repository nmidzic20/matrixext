...
```
#CustomerId,#FullName,#Email,#Country,#Region,#Plan,#Seats,#MonthlySpend,#RenewalDate,#Owner,#Status,#SignupSource,#LastLogin,#FeatureFlags,#Notes,#CRMId,#Timezone,#Language,#BillingCycle,#Tags,#SupportTier,#MarketingOptIn,#Industry,#Employees,#ARR
...
- Colours for comments, keys, and values
...
![Rowtate Demo](https://cdn.jsdelivr.net/gh/nmidzic20/matrixext@master/rowtate/media/demo.gif)
